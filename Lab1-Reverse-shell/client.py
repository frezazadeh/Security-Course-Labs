...
def main():
    ...
    # Explanation: The client creates a socket and connects back to the server at (SERVER_IP, SERVER_PORT).
    try:
    ...
    # Explanation: The client now enters a loop to receive commands, execute them, and send results back.
    while True:
        try:
            data = s.recv(1024)
            if not data:
